...
const SponsoredProduct = ({ basicItemInfo, setBasicItemInfo }) => {
	const dispatch = useDispatch();
	const sponsoredProduct = useSelector(
		(state) => state.newRental.basicItemInfo.sponsoredProduct
	);

	console.log(sponsoredProduct);
	return (
			...
			<div className='px-4 py-5 sm:p-6'>
				...
				<div className='mt-2 sm:flex sm:items-start sm:justify-between'>
					<div className='max-w-xl text-sm text-gray-500'>
						<p>
							Optional: Promote your item at the top of the main category for
							rentals in your area for 30 days.
						</p>
						<p className='text-green-500 font-bold my-3'>$10.00</p>
					</div>
